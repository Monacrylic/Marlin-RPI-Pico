...
#define BOARD_INFO_NAME "CuriousMotor ONYX"

#if EXTRUDERS > 1 || E_STEPPERS > 1
  #error "ONYX only supports one E Stepper. Comment out this line to continue."
#elif HOTENDS > 1
  #error "ONYX E4 only supports one hotend / E-stepper. Comment out this line to continue."
#endif
